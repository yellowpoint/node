...
$('body').on('touchstart', '._js-historyback,.ALLhistoryback,.historyback', function() {
	window.history.back();
});
...
var indexPage = function() {
	...
	$(window).on("scroll", function() {
		...
		if(getCookie('channel') == 'i4'){
			$('#view-1 .topImg').css('background-image','url(../../img/indexBg_i4.png)');
			$('#view-1 .topImg').css('background-size','cover')
		}
	...
	//关闭弹出层
	$('body').on('click','.indexLayerClose',function(){
		layer.closeAll(); //疯狂模式，关闭所有层
		
	})
	
	//弹出层去领优惠券
	$('body').on('click','.couponGet',function(){
		window.location.href = '../coupon/getCoupon.html'
	})
}
...
var shopCarPage = function() {
	...
	//购物车为空的时候点击去定制按钮跳转
	$('#view-2 .page').on('touchstart', '.goToShop', function() {
		if(GetQueryString('from') == 'spreadIndex'){
			window.history.back();
		}else{
...
var myPage = function() {
	...
	//我的优惠券
	$('#view-3').on('click', '.allCoupon', function() {
		console.log(12341)
		window.location.href = '../coupon/couponList.html?channel=' + channel;
	})
}
...
var goodsDetailPage = function() {
	...
	$('#goodDetail .toolbar').on('click', '.bugNow', function() {
		...
		var MapKv =  {"goodsName":goodsName,"goodsId":goodsId,"channel":channel};
		console.log(MapKv)
		TDAPP.onEvent ('点击立即购买','商品详情页面',MapKv);
		var url, successFun;
		url = apiDomain + '/diyapi/goods/overview?goodsId=' + goodsId;
		successFun = function(data) {
			var operate = ''
	...
	//点击去定制
	$('#goodDetail .toolbar').on('click','.goDiy',function(){
		//添加talkingData点击事件监测		
		var goodsId = $('body .detail-goodsOuter').attr('data-goodsId'),
		goodsName = $('body .detail-goodsOuter').attr('data-goodsName'),
		channel = GetQueryString('channel') || getCookie('channel') || 'etime';
		setCookie('channel', channel);
		var MapKv =  {"goodsName":goodsName,"goodsId":goodsId,"channel":channel}
		TDAPP.onEvent ('点击开启定制之旅','商品详情页面',MapKv);
	})
...
var orderConfirmPage = function() {
	...
	userCouponIds = localStorage.getItem('userCouponIds'); //获取优惠券ID
	//修改确认订单页面商品数量
...
//		var chooseAddressId = localStorage.getItem('chooseAddressId');
		...
		successFun = function(data) {
			...
			exemptAmount1 = exemptAmount.split(".")[0],
			exemptAmount2 = exemptAmount.split(".")[1],
			tradeOrder = data.data.tradeOrder,
			//总金额
			totalAmount = toDecimal2(tradeOrder.amount),
			totalAmount1 = totalAmount.split(".")[0],
			totalAmount2 = totalAmount.split(".")[1],
			//实际支付金额
			payAmount = toDecimal2(tradeOrder.payAmount),
			payAmount1 = payAmount.split(".")[0],
			payAmount2 = payAmount.split(".")[1],
			//邮费
			expressFee = toDecimal2(tradeOrder.expressFee),
			expressFee1 = expressFee.split(".")[0],
			expressFee2 = expressFee.split(".")[1],
			//总数量
			totalNum = tradeOrder.num,
			
			//是否有可用的优惠券
			validCouponNum = data.data.validCouponNum,
					
			//立减优惠
			exemptAmount = toDecimal2(data.data.exemptAmount),
			goodsList = data.data.tradeOrder.goodsList,
			amount = toDecimal2(data.data.tradeOrder.amount), //将拿到的金额强制转换成带两位小数的浮点型
			amount1 = amount.split(".")[0],
...
//				dataBox = '<a href="../subject/coupon.html" style="color:#575757"><span class="_fm-left">选择优惠券：</span><div class="right-ico _fm-right" style="margin-top: -3px;"><span class="_fm-back-right">&nbsp;</span></div><div class="msg _fm-overhide"><span class="_fm-right _fm-ellipsis">无可用优惠券</span></div></a>'
				...
				dataBox = '';
				if (!validCouponNum == 0) {
					if(localStorage.getItem('totalCoupon')){
						dataBox = '<a href="../coupon/preoderCoupon.html?channel='+ channel +'&tradeOrderId='+ tradeOrderId +'" style="color:#575757" class="external"><span class="_fm-left">选择优惠券：</span><div class="right-ico _fm-right" style="margin-top: -3px;"><span class="_fm-back-right">&nbsp;</span></div><div class="msg _fm-overhide"><span class="_fm-right _fm-ellipsis" style="color: #ff5252;">-￥'+ localStorage.getItem('totalCoupon') +'</span></div></a>'
					}else{
						dataBox = '<a href="../coupon/preoderCoupon.html?channel='+ channel +'&tradeOrderId='+ tradeOrderId +'" style="color:#575757" class="external"><span class="_fm-left">选择优惠券：</span><div class="right-ico _fm-right" style="margin-top: -3px;"><span class="_fm-back-right">&nbsp;</span></div><div class="msg _fm-overhide"><span class="_fm-right _fm-ellipsis">选择优惠券</span></div></a>'
					}

				} else{
					dataBox = '<a href="../coupon/preoderCoupon.html?channel='+ channel +'&tradeOrderId='+ tradeOrderId +'" style="color:#575757" class="external"><span class="_fm-left">选择优惠券：</span><div class="right-ico _fm-right" style="margin-top: -3px;"><span class="_fm-back-right">&nbsp;</span></div><div class="msg _fm-overhide"><span class="_fm-right _fm-ellipsis">无可用优惠券</span></div></a>'
//					dataBox = '<a href="../subject/coupon.html" style="color:#575757"><span class="_fm-left">选择优惠券：</span><div class="right-ico _fm-right" style="margin-top: -3px;"><span class="_fm-back-right">&nbsp;</span></div><div class="msg _fm-overhide"><span class="_fm-right _fm-ellipsis">无可用优惠券</span></div></a>'
				}
		...
		if (chooseAddressId && chooseAddressId !== 'undefined') {
			if (userCouponIds && userCouponIds !== 'undefined') {
				loadData(apiDomain + '/diyapi/trade/preorder/detail?tradeOrderId=' + tradeOrderId + '&deliveryAddressId=' + chooseAddressId + '&userCouponIds=' + userCouponIds, true, successFun);
			} else{
			...
			if (userCouponIds && userCouponIds !== 'undefined') {
				loadData(apiDomain + '/diyapi/trade/preorder/detail?tradeOrderId=' + tradeOrderId + '&userCouponIds=' + userCouponIds, true, successFun);
			} else{
					...
					$.each(data.data, function(i) {
						if (data.data[i].expressFee !== 0) {
							if(data.data[i].isRemote == true){
								...
								layerExpreFee += '<section class="../subject/expressFeeList"><div class="ExpreHeader"><span class="shopNameExpress">' + data.data[i].name + '</span><span class="exprePrice">共' + data.data[i].expressFee + '元<i>(快递)</i></span></div><div class="ExpreGoodsList"><div class="ExpreGoodsImg">'
							}
	...
	$('.backToCar').on("click", ".left", function() {
		myApp.confirm('便宜不等人，请三思而行~', '', function() {
			...
			if(localStorage.getItem('isCoupon') == 2){
				window.history.go(-3);
			}else{
				window.history.back();
			}
			window.localStorage.setItem('isCoupon', 1);
			loadPage();
		});
	...
	$('body').on('click', '.submit', function() {
		//如果是单个商品就添加talkingData点击事件监测
		if($('.goods-detailList>.goods-content').hasClass('onegoods')){
			var goodsName = $('.onegoods').attr('data-goodsName'),
			goodsId = $('.onegoods').attr('data-goodsId');
			var MapKv =  {"goodsName":goodsName,"goodsId":goodsId,"channel":channel};
			TDAPP.onEvent ('点击提交订单','确认订单页面',MapKv);
		}
		...
		if(userCouponIds){
			userCouponIds = userCouponIds.toString();
		}
		var data = {
			'tradeOrderId': tradeOrderId,
		...
		if(amount == 0){
			$.ajax({
					...
					success: function(data) {
						...
						} else if (data.code == 3001 || data.code == 3040) {
							layer.open({
...
var loadPage = function() {
	...
	$('.view>.toolbar .toolbar-inner').find('a').eq(1).attr("href",'../material/chooseModel.html?button=uploadImg&channel='+ channel +'_materialPriority'); 
	//爱思渠道时将背景遮罩图片改变
	if(getCookie('channel') == 'i4'){
		$('#view-1 .topBg').css({'background-image':'url(../../img/indexBg_i4.png)','background-size':'cover'});
		$('#view-3 .myTop').css({'background-image':'url(../../img/myBg_i4.png)','background-size':'cover'});
		$('#goodDetail .themeColor img').attr('src','../../img/detailBg-i4.png');
		$('#ipRecommend .topBg img').attr('src','../../img/bindBg-i4.png');
		$('#RecomCon .topBg img').attr('src','../../img/bindBg-i4.png');
		$('#brandZone .topBg img').attr('src','../../img/brandBg-i4.png');
		$('#subjectRecommend .topBg img').attr('src','../../img/bindBg-i4.png');
//		$('.view>.toolbar .toolbar-inner').find('a').eq(1).attr("href",'https://api.51app.cn/webPage/activity/i4Activity_0322.html?channel=i4'); 
		...
		if (pageName == "index-1") { //加载首页数据
			...
			successFun = function(data) {
				if (data.code == 200) {
					...
					//因为目前腾趣web和app用的是同一个接口，并且接口没有进行渠道区分，而且app页面的跳转与web有所不同（app是给ios/安卓传值），所以在爱思渠道下手动增加一张banner
					//由于commom.js里面设置了只能跳转web目录下的文件，因此重新写了点击事件进行跳转
					if(channel == 'i4'){
//						dataBox += '<div class="swiper-slide" onclick="window.location.href=\'https://api.51app.cn/webPage/activity/i4Seat12.html?seat=12&from=banner\'"><div><img src="../../img/i4_banner.jpg"  alt="banner" /></div></div>'
						dataBox += '<div class="swiper-slide" onclick="window.location.href=\'https://api.51app.cn/webPage/tq/web/html/material/chooseModel.html?button=uploadImg&channel=i4N_materialPriority\'"><div><img src="../../img/i4_banner2.jpg"  alt="banner" /></div></div>'
					}
//						dataBox += '<div class="swiper-slide" onclick="window.location.href=\'https://api.51app.cn/channel/chooseModel.html?button=uploadImg&channel=i4_materialPriority\'"><div><img src="../../img/i4_banner2.jpg"  alt="banner" /></div></div>'
					...
					//因为目前腾趣web和app用的是同一个接口，并且接口没有进行渠道区分，而且app页面的跳转与web有所不同（app是给ios/安卓传值），所以在爱思渠道下手动增加一个小图标按钮
					//由于commom.js里面设置了只能跳转web目录下的文件，因此重新写了点击事件进行跳转
					if(channel == 'i4'){
//						dataBox +=  '<a class="nav_item external" onclick="window.location.href=\'https://api.51app.cn/webPage/activity/i4Seat12.html?seat=12&from=pane\'"><img src="../../img/0Buy.gif"/><span class="_fm-f-12">0元购</span></a>'
					}
					...
					//首页优惠券弹窗(规则：判断首页url是否有带token，有token就传给后台进行验证是否是新用户首次登陆，没有token就直接弹)
					if(getCookie('token')){
						var token = getCookie('token');
						var url,data,successFun;
						url = apiDomain + '/diyapi/ad/home/popup2';
						data = {
							'token':token,
						...
						if(channel == 'i4'){
							...
							indexLayer();  //暂时去掉爱思渠道下没有token就弹出优惠券弹窗
						}
					}
			...
			successFun = function(data) {
				if (data.code == 200) {
					if (data.data.length != 0) {
						...
						if(GetQueryString('from') == 'spreadIndex'){
							$('#view-2 .toolbar').hide();
							$('#view-2 .addCar').css('bottom',0);
							$('#view-2 .page').css('padding-top','44px');
							$('#view-2 .page-content').css('padding-bottom','1rem')
						}else{
							$('#view-2 .headImg').hide();
						}
						$('#view-2 .page').empty().append(dataBox);
						...
						if(isIphoneX()){
							...
							if(isIphoneX() && $(window).height() == 690){
//								$('.toolbar').css('height','50px');
//								$('.toolbar-inner').css('padding-bottom','0');
//								$('.tabbar.addCar').css('bottom','47px');
							$('.toolbar').css('height','74px');
							$('.toolbar-inner').css('padding-bottom','24px');
							$('.tabbar.addCar').css('bottom','71px');
							}
			...
			successFun = function(data) {
				if (data.code == 200) {
					...
					if (data.data.isAgency) {
						if(address){
							dataBox = '<li><div class="squareCon"><img src="../../img/myWallet.png" /><div class="squareright"><p class="_fm-ellipsis _fm-f-16">我的钱包</p><p class="_fm-ellipsis _fm-f-13">' + data.data.cash.toFixed(2) + '元</p></div></div></li><li class="allCoupon"><div class="squareCon"><img src="../../img/myCoupon.png" /><div class="squareright"><p class="_fm-ellipsis _fm-f-16">我的优惠券</p><p class="_fm-ellipsis _fm-f-13">' + data.data.couponCount.valid + '张</p></div></div></li><li class="reciveAddress"><div class="squareCon"><img src="../../img/myAddress.png" /><div class="squareright"><p class="_fm-ellipsis _fm-f-16">我的收货地址</p><p class="_fm-ellipsis _fm-f-13">' + address.provinceName + ' ' + address.cityName + ' ' + address.countyName + ' ' + address.address + ' </p></div></div></li><li><div class="squareCon"><img src="../../img/myGoldBean.png" /><div class="squareright"><p class="_fm-ellipsis _fm-f-16">我的金豆</p><p class="_fm-ellipsis _fm-f-13">' +
							...
							dataBox = '<li><div class="squareCon"><img src="../../img/myWallet.png" /><div class="squareright"><p class="_fm-ellipsis _fm-f-16">我的钱包</p><p class="_fm-ellipsis _fm-f-13">' + data.data.cash.toFixed(2) + '元</p></div></div></li><li class="allCoupon"><div class="squareCon"><img src="../../img/myCoupon.png" /><div class="squareright"><p class="_fm-ellipsis _fm-f-16">我的优惠券</p><p class="_fm-ellipsis _fm-f-13">' + data.data.couponCount.valid + '张</p></div></div></li><li class="reciveAddress noAddress"><div class="squareCon"><img src="../../img/myAddress.png" /><div class="squareright"><p class="_fm-ellipsis _fm-f-16">我的收货地址</p><p class="_fm-ellipsis _fm-f-13">添加收货地址</p></div></div></li><li><div class="squareCon"><img src="../../img/myGoldBean.png" /><div class="squareright"><p class="_fm-ellipsis _fm-f-16">我的金豆</p><p class="_fm-ellipsis _fm-f-13">' +
							data.data.coin + '个</p></div></div></li><li class="agentProfit"><div class="squareCon"><img src="../../img/myProfit.png" /><div class="squareright"><p class="_fm-ellipsis _fm-f-16">我的收益</p><p class="_fm-ellipsis _fm-f-13">' +
							data.data.cashableBalance.toFixed(2) + '元</p></div></div></li>'
						}
						...
						if(address){
							dataBox = '<li><div class="squareCon"><img src="../../img/myWallet.png" /><div class="squareright"><p class="_fm-ellipsis _fm-f-16">我的钱包</p><p class="_fm-ellipsis _fm-f-13">' + data.data.cash.toFixed(2) + '</p></div></div></li><li class="allCoupon"><div class="squareCon"><img src="../../img/myCoupon.png" /><div class="squareright"><p class="_fm-ellipsis _fm-f-16">我的优惠券</p><p class="_fm-ellipsis _fm-f-13">' + data.data.couponCount.valid + '张</p></div></div></li><li class="reciveAddress"><div class="squareCon"><img src="../../img/myAddress.png" /><div class="squareright"><p class="_fm-ellipsis _fm-f-16">我的收货地址</p><p class="_fm-ellipsis _fm-f-13">' + address.provinceName + ' ' + address.cityName + ' ' + address.countyName + ' ' + address.address + ' </p></div></div></li><li><div class="squareCon"><img src="../../img/myGoldBean.png" /><div class="squareright"><p class="_fm-ellipsis _fm-f-16">我的金豆</p><p class="_fm-ellipsis _fm-f-13">' +
							data.data.coin + '个</p></div></div></li>'
						}else{
							dataBox = '<li><div class="squareCon"><img src="../../img/myWallet.png" /><div class="squareright"><p class="_fm-ellipsis _fm-f-16">我的钱包</p><p class="_fm-ellipsis _fm-f-13">' + data.data.cash.toFixed(2) + '</p></div></div></li><li class="allCoupon"><div class="squareCon"><img src="../../img/myCoupon.png" /><div class="squareright"><p class="_fm-ellipsis _fm-f-16">我的优惠券</p><p class="_fm-ellipsis _fm-f-13">' + data.data.couponCount.valid + '张</p></div></div></li><li class="reciveAddress noAddress"><div class="squareCon"><img src="../../img/myAddress.png" /><div class="squareright"><p class="_fm-ellipsis _fm-f-16">我的收货地址</p><p class="_fm-ellipsis _fm-f-13">新增收货地址</p></div></div></li><li><div class="squareCon"><img src="../../img/myGoldBean.png" /><div class="squareright"><p class="_fm-ellipsis _fm-f-16">我的金豆</p><p class="_fm-ellipsis _fm-f-13">' +
							data.data.coin + '个</p></div></div></li>'
						}
			...
			successFun = function(data) {
				...
				if (data.code == 200) {
					...
					if (agencyPrice) {
						...
						dataBox += '<div class="detail-goodsOuter" data-diyType="' + goods.diyType + '" data-goodsId="' + goods.id + '" data-goodsName="'+ goods.name +'"><div class="detail-good-top" data-id="' + goods.id + '"><span class="detail-goodName"><i style="opacity: 0;"></i>' + goods.name + '</span></div></div><div><div class="detail-good-middle detail-agentGood-middle">代理价<span class="detail-agentGoodPrice">￥<i>' + agencyPrice1 + '.<i style="font-size:0.32rem!important">' + agencyPrice2 + '</i></i></span><span class="detail-agentOldGoodPrice"><i>￥&nbsp;' + originalPrice1 + '.' + originalPrice2 + '</i></span><span class="detail-agentPeopel"><img src="../../img/giftIcon.png"><b>' + goods.soldNum + '人购买</b></span></div></div>'
					} else {
						//普通用户
						dataBox = '<div class="detail-goodsOuter" data-diyType = "' + goods.diyType + '" data-goodsId="' + goods.id + '" data-goodsName="'+ goods.name +'"><div class="detail-good-top" data-id="' + goods.id + '"><span class="detail-goodName"><i></i>' + goods.name + '</span></div></div><div><div class="detail-good-middle"><span class="detail-goodPrice">￥<i>' + goodPrice1 + '.<i style="font-size:0.32rem!important">' + goodPrice2 + '</i></i></span><span class="detail-oldGoodPrice"><i>￥&nbsp;' + originalPrice1 + '.' + originalPrice2 + '</i></span><span class="detail-peopel"><img src="../../img/giftIcon.png"/><b>' + goods.soldNum + '人购买</b></span></div></div>'
					}
					//有活动时显示，没有活动时不显示活动一栏
					...
					//判断是否为自营商品，有就显示
					if (goods.isOwn == true) {
						$('.detail-goodName i').css("display", 'inline-block');
					} else {
						$('.detail-goodName i').css("display", 'none');
					};
					...
					if (goods.diyType == 1) {
						...
						var goodsId = GetQueryString('goodsId');
						dataBox = '<a href="diy.html?channel=' + channel + '&goodsId=' + goodsId + '" class="tab-link external goDiy"><span class="">开启定制之旅</span></a>'
						$('#goodDetail .toolbar').css('background-color', '#fff');
				...
				if (data.data != '' && data.data != null) {
					$.each(data.data, function(i) {
						...
						if (data.data[i].status == 0) {
							...
							dataBox += '</div><p class="division1 _fm-rel"></p><div class="OrderTotal"><span class="qualityTotal">共<i>' + data.data[i].num + '</i>件商品</span><span class="priceTotal">合计:￥<i class="totalAmount">' + totalAmount + '</i>(含运费:￥<i>' + expressFee + '</i>)</span></div><p class="division1 _fm-rel"></p><div class="elem-footer _fm-overhide"><span class="do viewLogistics" data-expressNo="' + expressNo + '" data-expressCompanyCode="'+ data.data.expressCompanyCode +'">查看物流</span><span class="do confirmReceipt">确认收货</span></div></section>'
						} else if (data.data[i].status == 8 || data.data[i].status == 3) {
							dataBox += '</div><p class="division1 _fm-rel"></p><div class="OrderTotal"><span class="qualityTotal">共<i>' + data.data[i].num + '</i>件商品</span><span class="priceTotal">合计:￥<i class="totalAmount">' + totalAmount + '</i>(含运费:￥<i>' + expressFee + '</i>)</span></div><p class="division1 _fm-rel"></p><div class="elem-footer _fm-overhide"><span class="do viewLogistics" data-expressNo="' + expressNo + '" data-expressCompanyCode="'+ data.data.expressCompanyCode +'">查看物流</span><span class="do deleteOrder">删除订单</span></div></section>'
					...
					dataBox = '<div style="text-align: center;margin-top: 2.5rem;"><div><img src="../../img/noOrder.png"/ style="width:3.49rem;margin: 0 auto;padding-bottom:0.5rem"></div><div class="no-order">您还没有订单哦，<a style="color:#007aff!important" href="#" class="external">赶紧去下单吧</a></div></div>'
				}
...
$('.order-list').on('click', '.addShoppingCar', function() {
	...
	//添加talkingData点击事件监测
	var MapKv =  {"tradeOrderId":tradeOrderId,"token":token,"channel":channel};
	TDAPP.onEvent ('点击加入购物车','订单详情页面',MapKv);
...
$('.order-list').on('click', '.viewLogistics', function() {
	...
	var expressCompanyCode = $(this).attr('data-expressCompanyCode');
	window.location.href = 'https://m.kuaidi100.com/index_all.html?type='+ expressCompanyCode +'&postid=' + expressNo + '&callbackurl=' + nowUrl;
})
...
//点击上方tab栏
$('.order-list .sub-navi').on('click', 'li', function() {
...
$('.order-list').on('touchstart','.no-order',function(){
	if(GetQueryString('from') == 'spreadIndex'){
		window.history.back();
	}else{
		window.location.href = "index.html?channel=" + channel;
	...
	successFun = function(data) {
		if (data.code == 200) {
			...
			if (tradeOrder.status == 0) {
				...
				dataBox = '<div class="left-ico _fm-left orderToRecive" data-expressNo="' + logistic.expressNo + '" data-expressCompanyCode="'+ tradeOrder.expressCompanyCode +'"><i class="_fm-rel _fm-inline _fm-txtcenter">&nbsp;</i></div><div class="msg"><p class="_fm-overhide _fm-f-15" style="margin-bottom: 0.2rem;"><span class="status _fm-left _fm-ellipsis">待收货</span></p><div class="time _fm-overhide">' + logistic.trace.time + '</div></div>';
				dataBox1 = '<span class="do viewLogistics" data-expressNo="' + logistic.expressNo + '" data-expressCompanyCode="'+ tradeOrder.expressCompanyCode +'">查看物流</span><span class="do or confirmReceipt">确认收货</span><span class="do srevice">联系客服</span>'
			...
			//使用优惠券金额
			var couponAmount = toDecimal2(tradeOrder.couponAmount);
			...
			//使用优惠券金额
			var dataBox = "";
			dataBox = ' <span class="_fm-left">优惠券：</span><span class="_fm-right _js-formatGoodsPrice haveDone" data-size="14px">-￥' + couponAmount + '</span>';
			$('.order-detail .page .couponAmount').empty().append(dataBox);
...
$('body').on('click', '.OrderToRecive', function() { //查看物流
		...
		var expressCompanyCode = $(this).find('.orderToRecive').attr('data-expressCompanyCode');
		window.location.href = 'https://m.kuaidi100.com/index_all.html?type='+ expressCompanyCode +'&postid=' + expressNo + '&callbackurl=' + nowUrl;
	})
	//确认收货
...
var personalCenter = function() {
	...
	successFun = function(data){
		if(data.code == 200){
			...
			+ channelUrl +'</p><p class="text">长按复制渠道编码</p></div><div class="middle"><div class="linkBox order" data-type="1"><div class="linkBoxCon"><img src="../../img/wechatORDER.png"/><div><p>查看订单</p><p>订单详情</p></div></div></div><div class="linkBox cash"><div class="linkBoxCon"><img src="../../img/wechatCASH.png"/><div><p>查看收益</p><p>我的收益</p></div></div></div></div><div class="bottom"><ul><li class="takeCashType"><span class="right1"></i></span><span class="left">提现方式</span></li><li><a href="tel:0755-86536781" class="right1 external">0755-86536781</a><span class="left">联系客服</span></li></ul></div></div>'
			...
			if(isBindAliapy == false && isBindWx == false){
				$('.bottom ul li').eq(0).find('.right1').html('未绑定')
			}else if(isBindAliapy == true && isBindWx == false){
				$('.bottom ul li').eq(0).find('.right1').html('已绑定<i class="wechatZFB"></i>')
			}else if(isBindAliapy == false && isBindWx == true){
				$('.bottom ul li').eq(0).find('.right1').html('已绑定<i class="wechatWX"></i>')
			}else if(isBindAliapy == true && isBindWx == true){
				$('.bottom ul li').eq(0).find('.right1').html('已绑定<i class="wechatZFB"></i><i class="wechatWX"></i>')
			}
			...
			dataBox = '<div class="weChatIndex"><div class="personInfo"><div class="info"><div class="head"><img src="'+ head +'" /></div><div class="headRight"><p>尊贵的用户</p><p>'+ 
			 mobile +'</p></div><div class="changeNum"></div></div><div class="joinAgency"><img src="../../img/wechatJoinAgency.png"/></div></div><div class="middle"><div class="linkBox order" data-type="1"><div class="linkBoxCon"><img src="../../img/wechatORDER.png"/><div><p>查看订单</p><p>订单详情</p></div></div></div><div class="linkBox mall"><div class="linkBoxCon"><img src="../../img/wechatMall.png"/><div><p>进入商城</p><p>定制商城</p></div></div></div></div><div class="bottom"><ul><li><a href="tel:0755-86536781" class="right1 external">0755-86536781</a><span class="left">联系客服</span></li></ul></div></div>'
			$('#personalCenter .page-content').empty().append(dataBox);
