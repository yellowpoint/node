<!-- 设置组件 -->
<template>
	<div class="agreement-popup fadeIn" @click="close" ref="agreementPopup" @touchstart="test1($event)" @touchend="test2($event)" @touchmove.prevent style="animation-duration: 0.3s;">
		<div class="content-wrap" @click.stop >
            <div class="headerTitle">《爱挖矿池用户协议》</div>
            <!-- <v-scroll>
               
            </v-scroll>  -->
            <div v-if="isPC" class="pcScrollBox">
                <div class="scrollBox">
            ...
            <v-scroll v-else class="contentText">
                <div class="scrollBox">
                    <div class="blockBox"></div>
                    <div class="item"
                        v-for="(items, indexs) in agreementList"
            ...
            <div class="footer">
                <button class="confirmBtn" @click="submitAgreement">同意</button>
                <div class="dapBtn" @click="close">跳过</div>
            </div>
		</div>
	</div>
</template>
		...
		methods: {
			...
			*/
            ...
            submitAgreement() { // 提交协议
                this.$api.submitSigned().then( res => {
    ...
    .agreement-popup{
        ...
        .content-wrap{
            ...
            .pcScrollBox{
                ...
                background: url('~assets/images/register/awLogo.png') no-repeat center center;
                .item{
                    .title{
                        color: #333;
                        font-weight: bold;
            ...
            .footer{
                ...
                .confirmBtn{
                    ...
                    cursor: pointer;
                    box-shadow: 0 0 0.13rem 0 rgba(56,80,185,0.65);
